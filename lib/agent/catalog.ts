...
export const agentActionCatalog: AgentActionDefinition[] = [
  ...
  { id: "set_initial_balance", label: "Ajustar saldo", status: "implemented", changesData: true, description: "Atualiza o ponto de partida do saldo sem criar movimentacao." },
